...
CREATE INDEX idx_uploads_conversation ON uploads(conversation_id);

-- ═══════════════════════════════════════════════════════════
-- DOCUMENT COLLECTIONS (PDF / IMAGE → VLM OCR)
-- ═══════════════════════════════════════════════════════════
...
CREATE INDEX idx_collections_conversation ON collections(conversation_id);
...
CREATE INDEX idx_collection_files_user ON collection_files(user_id);
